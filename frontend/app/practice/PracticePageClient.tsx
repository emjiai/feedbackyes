...
export default function PracticePageClient() {
  ...
  if (showRolePlaySetup) {
    return (
      <RolePlaySetup onComplete={handleRolePlayComplete} onCancel={() => setShowRolePlaySetup(false)} />
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Choose a workplace scenario to practice your communication skills</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg shadow-lg p-6 mb-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="opacity-90">Design your own feedback scenario with specific cultural context and relationship dynamics</p>
          </div>
          <button
